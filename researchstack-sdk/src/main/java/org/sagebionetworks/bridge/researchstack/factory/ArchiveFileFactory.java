...
public class ArchiveFileFactory {
    ...
    public ArchiveFile toBridgeArchiveFile(@NonNull Result result) {
        checkNotNull(result);
        checkNotNull(result.getIdentifier());
        checkNotNull(result.getEndDate());

        if (result instanceof StepResult) {
            return toArchiveFile((StepResult) result);
        } else if (result instanceof FileResult) {
            return toArchiveFile((FileResult) result);
        } else {
    ...
    @VisibleForTesting
    JsonArchiveFile toArchiveFile(StepResult result) {
        DateTime endTime = new DateTime(result.getEndDate());
    ...
    @VisibleForTesting
    ByteSourceArchiveFile toArchiveFile(FileResult result) {
        DateTime endTime = new DateTime(result.getEndDate());
